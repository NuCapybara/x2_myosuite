...
trans_bp_lt = [0.207275, -0.220265, 0.13831]
q_bp_lt = [-1, 0, 0, 0]
...
#result of Tworld_left_thigh

Tw_lt = Tw_bp @ Tbp_lt
print("Transformation Matrix:\n", Tw_lt)
q_world_to_leftthigh = rotation_matrix_to_quaternion(Tw_lt)
print("Quaternion for world2left thigh:\n", q_world_to_leftthigh)
trans_world_to_leftthigh = Tw_lt[:3, 3]
print("Translation for world2left thigh", trans_world_to_leftthigh)
